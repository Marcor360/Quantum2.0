...
const Home: React.FC = () => {
  ...
  const slides: { imgUrl: string; content: JSX.Element }[] = [
    ...
    },
    {
      ...
      content: (
        <>
          <h2 className="text-base sm:text-lg md:text-5xl font-bold mb-4 md:text-[#3b0394] text-white font-subjectivity tracking-wide drop-shadow-lg pr-10 uppercase">
          ...
          <p className="text-xs sm:text-sm md:text-lg text-white md:text-[#3b0394] font-subjectivity leading-relaxed font-medium py-2 pr-30">
            Te llevamos a{" "}
    ...
    <>
      ...
      >
        ...
        >
              ...
              <div>
                ...
                >
                  {[
                    ...
                    <li
                      key={label}
                      className="bg-pink-400 rounded-full flex items-center justify-center w-24 h-24 sm:w-24 sm:h-24 text-center text-[11px] sm:text-[0.6rem] leading-tight whitespace-normal break-words px-1 text-white font-bold"
                    >
                      {label}
                    </li>
                  ))}
          ...
          {/* Overlay escritorio */}
          <div className="hidden md:flex absolute inset-0 z-10 items-center justify-end pl-7 sm:pl-10 md:pl-16 lg:pl-25 pr-24 sm:pr-40 md:pr-60 xl:pr-60 2xl:pr-[28rem] text-right">
            <div className="w-full max-w-screen-lg shrink-0 grid gap-y-8 text-white bg-black/60 md:bg-transparent md:backdrop-blur-0 p-4 md:p-0">
              {/* Encabezado */}
              <div>
              ...
              <div>
                ...
                >
                  {[
                    ...
                    <li
                      key={label}
                      className="bg-pink-400 rounded-full flex items-center justify-center w-28 h-28 text-center text-xs leading-tight whitespace-normal break-words px-1 text-white font-bold text-[13px]"
                    >
                      {label}
                    </li>
                  ))}
